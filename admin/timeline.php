  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <ul>
        ...
        <li><a href="transport_manage.php" class="nav-item active"><i class="fa-solid fa-truck-fast"></i> Transport Bookings <span class="pill"><?= e((string) $sidebarTransportCount) ?></span></a></li>
      </ul>
