...
<div class="app-shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      <ul>
        <li><a href="dashboard.php" class="nav-item active"><i class="fa-solid fa-grid-2"></i> Dashboard</a></li>
      ...
      <ul>
        <li><a href="users.php" class="nav-item"><i class="fa-solid fa-users"></i> Users <span class="pill"><?= e((string)$totalUsers) ?></span></a></li>
        <li><a href="admins.php" class="nav-item"><i class="fa-solid fa-user-shield"></i> Admins</a></li>
        <li><a href="bamboo_enquiries.php" class="nav-item"><i class="fa-solid fa-user-shield"></i> Bamboo Enquiries</a></li>
  ...
  <div class="main-col">
    ...
    <main class="content">
      ...
      <div class="page-head">
        <div>
          <div class="breadcrumb">Atlas <span class="sep">/</span> <span class="current">Dashboard</span></div>
